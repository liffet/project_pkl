        ...
        <div
            ...
            <div class="mt-20 text-center">
                ...
                <p class="text-[12px] text-gray-500 mb-6 leading-relaxed w-4/5 mx-auto">
                    Daftar untuk mulai mengelola perangkat jaringan kantor Anda secara mudah dan efisien.
                </p>
            </div>
                        ...
                        <div class="pl-3 pr-2 text-gray-400 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5zM4 21v-1a7 7 0 0114 0v1" />
                            </svg>
                        </div>
        ...
        <div class="w-full md:w-1/2 bg-white rounded-3xl overflow-hidden flex flex-col justify-center p-8">
            ...
            <div class="px-0 md:px-4 pb-6 text-left">
                <h5 class="text-[17px] font-bold text-black/70 mb-2">
                    Kelola Data & Komponen <br /> dengan Akun Anda
                </h5>
                <p class="text-[12px] text-black/70 leading-relaxed">
                    Dengan memiliki akun ManagementHub, Anda dapat mengatur, memantau, dan memperbarui informasi jaringan secara
                    efisien. Setiap pengguna memiliki akses sesuai peran untuk menjaga keamanan dan keakuratan data.
                </p>
            </div>
        </div>
    </div>
